def repeat3():
    ...
    if fight("Barbarian"):
        ...
        vars.decision_16 = story("Do you wish to take these?")
        ...
        vars.decision_16 = story("Will you either go STRAIGHT through the room\nor you may stop to LOOK at the paintings?")
        if vars.decision_16 == "LOOK":
            ...
            vars.decision_17 = story("Will you either ESCAPE through the north door or\nlook for a WEAPON to use against the Warlock's power?")
            if vars.decision_17 == "ESCAPE":
                change_stats(1, 2, "subtract")
                vars.decision_16 = "STRAIGHT"
            elif vars.decision_16 == "WEAPON":
        ...
        if vars.decision_16 == "STRAIGHT":
            ...
            vars.decision_16 = story("Do you wish to eat Provisions?")
            if vars.decision_16 == "YES":
                vars.provs -= 1
                change_stats(1, 4)
            ...
            vars.decision_16 = story("Examine the bits of WOOD?\nStudy the length of ROPE?\nLEAVE through the north door?")
            if vars.decision_16 == "WOOD":
                story("Both pieces of wood are Y-shaped and smooth,\nas if washed up from a river.")
                vars.equipment.append("Pieces Of Wood")
                vars.decision_17 = story("If you wish to take the pieces of wood you must\nchoose one item of equipment to leave behind. Which will you choose?")
                while vars.decision_17 not in vars.equipment:
                    vars.decision_17 = story("You don't have that. Which piece of equipment will you choose from your pack.")
                vars.equipment.remove(vars.decision_17.title())
                vars.decision_16 = story("Will you either LEAVE through the north door or stay and examine the ROPE?")
            if vars.decision_16 == "ROPE":
