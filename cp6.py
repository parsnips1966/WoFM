...
def checkpoint6():
    if vars.decision_14 == "YES":
        vars.decision_13 = story("The door is firmly locked. You may try to force it open, will you?")
        if vars.decision_13 == "YES":
            ...
            if not stat_test(0):
                ...
                if len(vars.equipment) > 0:
                    vars.decision_15 = story("However, the shield is heavy so you must choose a piece of\nequipment to leave behind. Which will you pick?")
                    while vars.decision_15.title() not in vars.equipment:
                        vars.decision_15 = story("You don't have that. Which piece of equipment will you choose from your pack?")
                    vars.equipment.remove(vars.decision_15.title())
                story("You now leave the room and continue up the corridor.")
                vars.decision_14 = "NO"

    if vars.decision_14 == "NO":
        ...
        vars.decision_14 = story("Do you wish to try opening the door?")
        if vars.decision_14 == "YES":
            vars.background = "room"
            ...
            vars.decision_15 = story("CLOSE the door quickly and continue on?\nDraw your sword and FIGHT?\nJAB the Dwarf with your sword and put on an evil laugh?")
            if vars.decision_15 == "CLOSE":
                vars.decision_14 = "NO"
            elif vars.decision_15 == "FIGHT":
        ...
        if vars.decision_14 == "NO":
            ...
            vars.decision_16 = story("On the wall are two levers and it seems these have something to do\nwith the portcullis. Do you wish to pull the RIGHT or LEFT lever?")
    vars.checkpoint = 7