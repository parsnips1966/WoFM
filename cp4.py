...
def checkpoint4():
    if vars.decision_7 == "YES":
        ...
        vars.decision_8 = story("Will you either draw your sword and LEAP forward at them\nor slam the door quickly and RUN on up the passage?")
        if vars.decision_8 == "LEAP":
            ...
            if fight("First Orc"):
                ...
                if fight("Second Orc"):
                    ...
                    vars.decision_8 = story("The name Farrigo Di Maggio is inscribed on a brass namplate on its lid.\nDo you wish to OPEN the box or LEAVE it behind?")
                    if vars.decision_8 == "OPEN":
                        ...
                        vars.decision_7 = "NO"
        elif vars.decision_8 == "RUN":
            vars.decision_7 = "NO"

    if vars.decision_7 == "NO":
        vars.background = "passage"
        vars.decision_8 = story("You eventually arrive at the end of the passage, at a three-way junction.\nWill you turn either to the WEST or to the EAST?")
        if vars.decision_8 == "WEST":
            ...
            vars.decision_8 = story("Will you investigate?")
            if vars.decision_8 == "YES":
                ...
                if vars.decision_9 == "CHIEFTAIN":
                    ...
                    vars.decision_10 = story("Seeing this will you ESCAPE through the door down the corridor or CONTINUE the fight.")
                    if vars.decision_10 == "ESCAPE":
                        change_stats(1, 2, "subtract")
                        if vars.hero > 0:
                            story("The Chieftain gets a hit on you as you Escape.")
                            vars.decision_8 = "BACK"
                    elif vars.decision_10 == "CONTINUE":
                        vars.decision_9 = "BOTH"
                if vars.decision_9 == "BOTH":
                    vars.background = "orc"
                    fight_tuto()
                    ...
                    if fight("Orc Chieftain"):
                        ...
                        if fight("Servant"):
                            ...
                            vars.decision_9 = story("Will you try to SMASH the lock with your sword\nor leave it alone and GO through the open door.")
                            if vars.decision_9 == "SMASH":
                                ...
                                if vars.hero[1] > 0:
                                    ...
                                    vars.decision_9 = story("Do you wish to eat some Provisions" + provs_tuto() + " here?")
                                    if vars.decision_9 == "YES":
                                        take_provs()
                                    ...
                                    vars.decision_8 = "NO"
                            elif vars.decision_9 == "GO":
                                vars.decision_8 = "NO"
                elif vars.decision_9 == "LEAVE":
                    vars.decision_8 = "NO"
            if vars.decision_8 == "NO":
                vars.background = "passage"
                story("You arrive back at the junction in the passage and walk straight on eastwards.")
                vars.decision_8 = "EAST"
        if vars.decision_8 == "EAST":
            vars.decision_11 = story("You arrive at another junction in the passage.\nWill you either go NORTHwards or continue EASTwards?")
    vars.checkpoint = 5